...
if __name__ == "__main__":
    ...
    parser.add_argument('--beta0', type=float, default=0.01, help="Policy entropy cost, beta 0 (default: 0.01)")
    parser.add_argument('--beta1', type=float, default=0.001, help="Prediction entropy cost, beta 1 (default: 0.001)")
    parser.add_argument('--beta2', type=float, default=0.001, help="L2 regularization weight for pi hat, beta 2 (default: 0.001)")
    parser.add_argument('--beta3', type=float, default=0.001, help="L2 regularization wright for y hat, beta 3 (default: 0.001)")
